...
url_permits_2017 = 'https://opendata.arcgis.com/datasets/42cbd10c2d6848858374facb06135970_9.csv'
permits2017 = 'permits_2018.csv'
...
collectData(url_permits_2017, permits2017)
df_permits2017 = clean_data(permits2017)
