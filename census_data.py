...
def bin_census_data(df, cat_name):
    df['INCOME_LEVEL'] = df[cat_name].apply(lambda x: 'LOW_INCOME' if x <= 30000 else ('MID_INCOME' if x <= 65000 else ('MID_HIGH_INCOME' if x < 100000 else 'HIGH_INCOME')))
...
def tract_to_cluster(df, cat_name):
    clusters = {
                ...
                '4': [1, 2.02, 2.01],
                '5': [108, 56, 55],
                '6': [107, 53.01, 42.02, 42.01],
                '7': [52.01, 50.01, 50.02, 49.02, 49.01, 48.02, 48.01],
                '8': [101, 58, 47.01, 47.02, 59],
                '9': [62.02, 102, 110, 64, 105],
                '10': [15, 14.02, 14.01],
                '11': [11, 10.01],
                '12': [13.01, 12, 13.02],
                ...
                '15': [6, 5.01, 5.02, 4],
                '16': [16, 103],
                '17': [17.02, 19.02, 19.01, 18.04, 18.03, 22.01],
                ...
                '22': [93.01, 93.02, 91.02],
                '23': [89.04, 89.03, 88.02, 88.04, 88.03],
                '24': [94, 111, 90],
                '25': [106, 84.1, 79.01, 79.03, 80.01, 81, 83.02, 83.01],
                '26': [68.04, 68.01, 68.02, 69, 67, 82, 80.02, 66, 65, 70, 84.02],
                '27': [71, 72],
                '28': [75.03, 75.04],
                '29': [96.01],
                '30': [96.02, 78.03],
                ...
                '39': [109, 73.01, 98.07, 98.11, 98.10, 97, 98.02, 98.01, 104, 98.04, 98.03]
            }
...
def extra_clean_up(df, year):
    ...
    if year == '2000':
        ...
        bin_census_data(df, 'FAGI_MEDIAN_2005')
    if year == '2010':
        ...
        bin_census_data(df, 'FAGI_MEDIAN_2015')
